...
const newJewelryProducts = [
    ...
    { img: 'https://jelwo.myshopify.com/cdn/shop/files/jewelry-product-21.jpg?v=1742445682', badge: null, title: 'Gold nose pin', price: 'Rs.12.00', oldPrice: null },
    { img: 'https://jelwo.myshopify.com/cdn/shop/files/jewelry-product-16.jpg?v=1742445682', badge: '20%', title: 'Blossom diamond bangle', price: 'Rs.28.00', oldPrice: 'Rs.35.00' },
    { img: 'https://jelwo.myshopify.com/cdn/shop/files/jewelry-product-46.jpg?v=1742445682', badge: null, title: 'Framed gold pendant', price: 'Rs.22.00', oldPrice: null }
];
...
// Reels data
const reelsData = [
    { video: 'video/Jelwopassword1.mp4', img: 'https://jelwo.myshopify.com/cdn/shop/files/jewelry-product-56.jpg?v=1742445682&width=165', title: 'Chic diamond ring', price: 'Rs. 22.00' },
    { video: 'video/Jelwo password 2.mp4', img: 'https://jelwo.myshopify.com/cdn/shop/files/jewelry-product-51.jpg?v=1742445540&width=165', title: 'Flower jhumka', price: 'Rs. 18.00' },
    { video: 'video/Jelwo password 3.mp4', img: 'https://jelwo.myshopify.com/cdn/shop/files/jewelry-product-1.jpg?v=1742443985&width=165', title: 'Sherbi ring', price: 'Rs. 26.00' },
    { video: 'video/Jelwo password 4.mp4', img: 'https://jelwo.myshopify.com/cdn/shop/files/jewelry-product-46.jpg?v=1742445430&width=165', title: 'Drop gold earrings', price: 'Rs. 14.00' },
    { video: 'video/Jelwo password 5.mp4', img: 'https://jelwo.myshopify.com/cdn/shop/files/jewelry-product-11.jpg?v=1742443330&width=165', title: 'Flower pandant', price: 'Rs. 22.00' },
    { video: 'video/Jelwo password 6.mp4', img: 'https://jelwo.myshopify.com/cdn/shop/files/jewelry-product-1.jpg?v=1742443985&width=165', title: 'Sherbi ring', price: 'Rs. 26.00' }
];
<div class="slider-arrow">
    <button class="arrow-prev swiper-button-disabled" aria-label="Previous slide" tabindex="-1"
        aria-controls="swiper-wrapper-e315482d556810957" aria-disabled="true" disabled=""><i
            class="feather-arrow-left"></i></button>
    <button class="arrow-next" aria-label="Next slide" tabindex="0"
        aria-controls="swiper-wrapper-e315482d556810957" aria-disabled="false"><i
...
//         <div class="overlay">
//           <button onclick="counter1" class="icon"><i class="fa fa-heart"></i></button>
//           <button onclick="counter2" class="icon"><i class="fa fa-eye"></i></button>
//         </div>
//         ${badgeHtml}
//       </div>
...
function createProductCardInner(product) {
    ...
    <div class="product-card-image">
        <a href="#"><img src="${product.img}" alt=""></a>
        <div class="product-card-timer">
        <span class="product-timer-item">
        <span class="strong days">00</span><em>DAYS</em></span
        <span class="timer-sep"></span>
        <span class="product-timer-item"><span class="strong hours">00</span><em>HRS</em></span>
        <span class="timer-sep"></span>
        <span class="product-timer-item"><span class="strong minutes">00</span><em>MIN</em></span>
        ...
        <div class="cart-action">
        <!-- ✅ Add to cart -->
        <button onclick="counter2.add()" class="add-to-cart">
            ADD TO CART
            </button>
        </div>
        </div>
...
if (productPageCards) {
    ...
    productPageCards.innerHTML = newJewelryProducts.map(createProductCardInner).join('');
}
